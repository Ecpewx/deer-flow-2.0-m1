...
class DeerFlowClient:
    ...
    @staticmethod
    def _serialize_explicit_planning_state(chunk: dict[str, Any]) -> dict[str, Any]:
        """Extract explicit planning fields from a values snapshot."""
        return {
            "intent_card": chunk.get("intent_card"),
            "conversation_state": chunk.get("conversation_state"),
            "action_decision": chunk.get("action_decision"),
        }
        ...
        for item in self._agent.stream(
            ...
            yield StreamEvent(
                ...
                data={
                    ...
                    **self._serialize_explicit_planning_state(chunk),
                },
            )
