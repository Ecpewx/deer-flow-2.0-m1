...
export function AppearanceSettingsPage() {
  ...
  const currentTheme = (theme ?? "system") as "system" | "light" | "dark" | "zufe-blue";
  ...
  const themeOptions = useMemo(
    () => [
      ...
      {
        id: "zufe-blue",
        label: t.settings.appearance.zufeBlue,
        description: t.settings.appearance.zufeBlueDescription,
        icon: PaletteIcon,
      },
    ...
    [
      ...
      t.settings.appearance.zufeBlue,
      t.settings.appearance.zufeBlueDescription,
    ],
  );
        ...
        <div className="grid gap-3 lg:grid-cols-4">
          {themeOptions.map((option) => (
            <ThemePreviewCard
              ...
              mode={option.id as "system" | "light" | "dark" | "zufe-blue"}
...
function ThemePreviewCard({
  ...
  description: string;
  active: boolean;
  mode: "system" | "light" | "dark" | "zufe-blue";
  systemTheme?: string;
  onSelect: (mode: "system" | "light" | "dark" | "zufe-blue") => void;
}) {
  const previewMode =
    mode === "system"
