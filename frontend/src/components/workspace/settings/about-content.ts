 ...
 */
export const aboutMarkdown = `# 😋[About ZUFE SMILE]

> **It's something unpredicatable, but in the end it's right.**

😋 ZUFE SMILE is a highly customized project based on DeerFlow, the open-source **super agent harness** that orchestrates **sub-agents**, **memory**, and **sandboxes** to do almost anything — powered by **extensible skills**.
