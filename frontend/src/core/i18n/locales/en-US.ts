...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 😋Zufe SMILE, a highly customized project based on the open-source project DeerFlow.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of 😋Zufe SMILE. With customized skills,\n😋Zufe SMILE can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. 浙财SMILE is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but 浙财SMILE could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "浙财SMILE's official website",
    githubTooltip: "浙财SMILE on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "浙财SMILE on GitHub",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to 浙财SMILE",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate 浙财SMILE faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how 浙财SMILE looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "浙财SMILE automatically learns from your conversations in the background. These memories help 浙财SMILE understand you better and deliver a more personalized experience.",
    ...
    appearance: {
      ...
      zufeBlue: "ZUFE Blue",
      zufeBlueDescription: "A blue-first theme inspired by ZUFE branding.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of 浙财SMILE.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "浙财SMILE only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
