...
>
> ⚠️ **Docker path note**: All hardcoded `skills/ppt-master/...` paths below assume the Docker mount `/mnt/skills/public/ppt-master/skills/ppt-master/...`. If your mount point differs, adjust accordingly.
...
```bash
python3 /mnt/skills/public/ppt-master/skills/ppt-master/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p "/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/`; project templates go to `/mnt/user-data/projects/<project>/templates/`
>
...
```bash
ls -la "/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 /mnt/skills/public/ppt-master/skills/ppt-master/scripts/svg_quality_checker.py "/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/<template_id>" --format <canvas_format>
```
...
Update `/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/layouts_index.json`:
...
If the human-facing `/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/README.md` summary table is maintained manually, sync it after updating the JSON index. The JSON index takes priority.
...
**Template Path**: `/mnt/skills/public/ppt-master/skills/ppt-master/templates/layouts/<template_id>/`
```
