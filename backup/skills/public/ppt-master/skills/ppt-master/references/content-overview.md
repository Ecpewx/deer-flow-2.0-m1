...
- **Narrative flow**: Hook → background → problem → solution → experiments → conclusion
- **Figures & tables**: What figures/tables from the source should appear on which slides
...
- **Data and metrics**
- **Figure/table references** (e.g., "图2", "表1")
- **Formula references** (e.g., "公式(1)-(3)")
