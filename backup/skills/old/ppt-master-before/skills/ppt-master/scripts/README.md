...
# or
python3 ${SKILL_DIR}/scripts/source_to_md/ppt_to_md.py <deck.pptx>
python3 ${SKILL_DIR}/scripts/project_manager.py init <project_name> --format ppt169 --dir /mnt/user-data/projects
...
```bash
python3 ${SKILL_DIR}/scripts/pptx_template_import.py <template.pptx>
python3 ${SKILL_DIR}/scripts/pptx_template_import.py <template.pptx> --manifest-only
```
...
```bash
python3 ${SKILL_DIR}/scripts/image_gen.py "A modern futuristic workspace"
python3 ${SKILL_DIR}/scripts/image_gen.py --list-backends
