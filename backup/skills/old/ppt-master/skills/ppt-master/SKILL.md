...
> 3. **NO CROSS-PHASE BUNDLING**: Once Step 4 (Eight Confirmations ⛔) user confirms, all subsequent non-BLOCKING steps auto-proceed
...
> 6. **NO SUB-AGENT SVG**: Step 6 SVG generation by main agent only
...
🚧 **GATE**: Project structure ready. ⛔ **BLOCKING** (wait for user response).

**Early-exit**: If user already stated "no template" / "自由设计", skip to Step 4.
...
**✅ Checkpoint — Template confirmed. Proceed to Step 4.**
...
**✅ Checkpoint — Proceed to Step 6.**

---

### Step 6: Executor Phase

🚧 **GATE**: Steps 4 (and 5 if applicable) complete.
